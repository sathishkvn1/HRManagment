...
// this
var addIdExport = tableId + '_export_to_pdf';
// var filterId = tableId + '_filter';
  // Create a button div with a button containing a Font Awesome icon for "Add New"
  var buttonDivExportPdf = document.createElement('div');
  buttonDivExportPdf.className = 'Export_pdf_btn_div';
  buttonDivExportPdf.innerHTML = '<button id="' + addIdExport + '" class="export_pdf_button" data-bs-toggle="modal" data-value="' + tableId + '" ><i class="far fa-file-pdf export-pdf-icon"></i>Export to pdf</button>';
  ...
  container_div_add_fiter.appendChild(buttonDivExportPdf);
