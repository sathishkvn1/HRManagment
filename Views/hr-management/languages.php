...
$("#btn_employee_language_data_table_filter").on("click", function () {
    ...
    $('#language_data_table_reset_filter').html(resetFilterLanguageText);
    
    
    if (filter_employee_id_languages === "0" && filter_employee_language === "0") {
        $("#language_data_table_reset_filter").hide();
    } else {
        $("#language_data_table_reset_filter").show();
    }
