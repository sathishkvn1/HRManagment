                        ...
                        <div id="company_structure_table_top" class="reviewBlock">
                          <!-- <div class="ant-card ant-card-bordered ant-card-small" style="width: 100%;"> -->
                            ...
                            <!-- <div class="ant-card-head"> -->
                                ...
                                <!-- <div class="name"> -->
                                 <!-- Education -->
                               <button id="education_data_table_add_new" class="add_new_btn_div" data-bs-toggle="modal" data-value="tbl_1" ><i class="fas fa-plus"></i> Add New</button>
                               <!-- <button id="education_data_table_filter" class="add_new_button" data-bs-toggle="modal" data-value="tbl_1" ><i class="fas fa-plus"></i> Filter</button> -->
                               <!-- <button id="education_data_table_export_to_pdf" class="add_new_button" data-bs-toggle="modal" data-value="tbl_1" ><i class="fas fa-plus"></i> Export Pdf</button> -->
                                <!-- </div> -->
