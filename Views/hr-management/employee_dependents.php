...
$("#dependent_data_table_add_new").on("click", function() {
    $("#flag_id").val("0");

    var modalId = "#dependent_data_table_modal";
    $(modalId).modal("show");
    ...
    $("#dependent_employee_id").prop("disabled", false);
    $("#dependent_employee_id").prop("readonly", false);
    $("#dependent_employee_id").css("cursor", "auto");
});
