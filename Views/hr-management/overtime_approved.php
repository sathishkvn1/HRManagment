...
<body>
                        ...
                        <!--for loading CompanyStructure DataTable -->
                            <table id="overtime_approved_data_table" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Employee Name</th>
 ...
 <!-- modal  -->
 <div class="modal fade data-table-modal" id="overtime_approved_modal" data-bs-backdrop="static">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="loan_request_modal_forms" class="modal_form">
                    ...
                    <div class="col-8">
                     <select class="form-control select2" id="overtime_approved_employee_id" name="overtime_approved_employee_id">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <input type="date" class="form-control" id="overtime_approved_date_of_request" name="overtime_approved_date_of_request">
                    </div>
                  </div>
                 <!-- ./ one field ---- -->  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <input type="date" class="form-control" id="overtime_approved_date" name="overtime_approved_date">
                    </div>
                  </div>
                 <!-- ./ one field ---- -->   
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control select2" id="overtime_approved_time_from" name="overtime_approved_time_from">
                    ...
                    <div class="col-8">
                      ...
                      <select class="form-control select2" id="overtime_approved_time_to" name="overtime_approved_time_to">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text"  name="approved_hours_worked"  id="approved_hours_worked"  class="form-control">
                        </input>
                      </div>
                    </div>
                  <!-- ./ one field ---- --> 
                  <!--one field  text field---- -->
                    ...
                    <div class="col-8">
                      <select class="form-control select2" id="approved_overtime_category_id" name="approved_overtime_category_id">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text"  name="approved_overtime_rate"  id="approved_overtime_rate"  class="form-control">
                        </input>
                      </div>
                    </div>
                  <!-- ./ one field ---- -->  
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text"  name="approved_overtime_rate_per_hour"  id="approved_overtime_rate_per_hour"  class="form-control">
                        </input>
                      </div>
                    </div>
                  <!-- ./ one field ---- -->  
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text"  name="approved_overtime_amount"  id="approved_overtime_amount"  class="form-control">
                        </input>
                      </div>
                    </div>
                  <!-- ./ one field ---- -->   
                 ...
                 <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text"  name="approved_overtime_remarks"  id="approved_overtime_remarks"  class="form-control">
                        </input>
                      </div>
                    </div>
                  <!-- ./ one field ---- -->  
                    ...
                    <select class="form-control" id="approved_overtime_request_status_id" name="approved_overtime_request_status_id">
                ...
                <div class="form-group row">
                      ...
                      <div class="col-8">
                        <textarea name="approved_overtime_rejection_reason"  id="approved_overtime_rejection_reason"class="form-control ">
                        </textarea>
                      </div>
                    </div>
                  <!-- ./ one field ---- -->  
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn savebtn" id="btn_approved_overtime_save"><i class="fas fa-calendar-check"></i>Save</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<script>
    ...
    $("#approved_overtime_rejection_reason").closest(".form-group.row").hide();

    $('#overtime_approved_data_table').DataTable({
    
   
   "ajax": {
     "url": BASE_URL + "index.php/" +  hrController + "/get_overtime_approved_details",
       "dataSrc": "data"
   },
   "columns": [
            ...
            { "data": "overtime_request_status" },
       {
           ...
           render: function (data, type, row) {
              ...
              return `
                  ...
                  <a href="#" class="view" onclick="viewOvertimeApproved('${data}');"><i class="fas fa-eye" ></i>View</a>
     ...
     "initComplete": function(settings, json) {
       customizeDataTable('overtime_approved_data_table');
   }
...
function viewOvertimeApproved(row_id) {
    alert("hai");
    $("#row_id").val(row_id);
    flag_id=$("#flag_id").val("1");
    $('#overtime_approved_modal').modal('show')
   $.ajax({
       url: BASE_URL + "index.php/" + hrController + "/get_overtime_approved_by_id",
       type: "POST",
       ...
       success: function (response) {
           ...
           var newOvertimeTimeFrom = moment(response.data.overtime_time_from, 'HH:mm:ss').format('HH:mm');
                ...
                //  alert(overtimeTimeTo);
                 ...
                 $("#overtime_approved_time_from").val(newOvertimeTimeFrom).trigger('change');

               
                 $("#overtime_approved_time_to").val(newOvertimeTimeTo).trigger('change');


              $("#overtime_approved_employee_id").val(response.data.employee_id).trigger('change');
              $("#overtime_approved_date_of_request").val(response.data.date_of_request);
              $("#approved_overtime_category_id").val(response.data.overtime_category_id).trigger('change');
              $("#overtime_approved_date").val(response.data.overtime_date);
         
              $("#approved_hours_worked").val(response.data.hours_worked);
              $("#approved_overtime_rate").val(response.data.overtime_rate);
              $("#approved_overtime_amount").val(response.data.overtime_amount);
              $("#approved_overtime_remarks").val(response.data.remarks);
              $("#approved_overtime_request_status_id").val(response.data.overtime_request_status_id).trigger('change');;
...
$("#btn_approved_overtime_save").on("click",function() {  
  // if ($('#new_request_status_modal_form').valid()) {
          var formData  = new FormData();
          formData.append('approved_overtime_request_status_id', $("#approved_overtime_request_status_id").val());
          formData.append('approved_overtime_rejection_reason', $("#approved_overtime_rejection_reason").val());
          formData.append('row_id', $("#row_id").val()); 
          formData.append('flag_id', $("#flag_id").val()); 
          formData.append('li_token', token); 
            $.ajax({
                     url: BASE_URL + "index.php/" + hrController + "/save_overtime_approved",
                     type: 'POST',
                     data:  formData,
                     dataType: "JSON",
                     processData: false,
