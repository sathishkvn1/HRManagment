           ...
           <div class="combined_buttons">
                   <div class="add_new_btn_div">
                    ...
                    <div class="reset_filter_btn_div">
                        <button id="education_data_table_reset_filter"  style="display:none" class="cancel_filter_button"><i class="fas fa-times"></i> Cancel</button>
                    </div>
...
$("#education_data_table_filter_btn").on("click", function() {

  $("#flag_id").val('0');
   $("#education_data_table_filter_modal").modal("show");
});


$("#education_data_table_reset_filter").on("click", function() {

  
     var table = $('#education_data_table').DataTable();
    var modal = $('#education_data_table_filter_modal');
